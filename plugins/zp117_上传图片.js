    ...
    exc('upload(file, option)', {
        ...
        option: {
            ...
            onSuccess: r => {
                ...
                if (ref.props.onSuccess) exc(ref.props.onSuccess, { ...ref.ctx, $ext_ctx: ref.ctx, ...r }, () => ref.exc("render()"))
                clean(ref)
            },
            onError: r => {
...
function url(ref) {
    ref.modal = <div className="zmodals">
        ...
        <div className="zmodal">
            ...
            <div className="zmodal-bd"><input placeholder="输入图片URL" className="zinput"/></div>
